    ...
    return (<>
        <footer className='flex justify-items-center bg-lime-200'>
            <ul className='flex flex-col gap-5'>
                <li>
                    <Link href="https://www.instagram.com/monasteriogrowshop/" className="bg-blue-300 text-gray-500 hover:bg-orange-300 duration-500">
                ...
                <li>
                    <Link href="https://www.facebook.com/monasteriogrowshop/" className="bg-blue-300 text-gray-500 hover:bg-orange-300 duration-500">
